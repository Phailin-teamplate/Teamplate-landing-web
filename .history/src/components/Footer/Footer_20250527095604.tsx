...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-muted/50 border-t border-border dark:bg-blacksection dark:border-strokedark ">
      <div className="max-w-7xl mx-auto py-10 px-4 sm:px-6 lg:px-8 md:text-left text-center">
        ...
        {/* Bottom copyright */}
        <div className="mt-8 border-t border-border pt-8 text-black dark:text-white hover:text-gray-400">
