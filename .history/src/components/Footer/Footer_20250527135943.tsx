        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4 md:justify-start justify-center">
              <a
                href="#"
                className="text-black dark:text-white hover:text-gray-500  transition-colors text-lg"
              >
                <FaFacebookF />
              </a>
              <a
              ...
              <a
                href="#"
                className="text-black dark:text-white dark:hover:text-gray-200 hover:text-gray-500 transition-colors text-lg"
              >
                <FaTiktok />
              </a>
              <a
