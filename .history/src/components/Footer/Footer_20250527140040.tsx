        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              ...
              {["/", "/about", "/stacks", "/contact"].map((path, index) => {
                ...
                return (
                  <li key={path}>
                    <Link
                      href={path}
                      className="text-black dark:text-white dark:hover:text-gray-400  hover:text-gray-500 transition-colors"
                    >
                      {names[index]}
                    </Link>
                  </li>
          ...
          <div>
            ...
            <div className="flex space-x-4 md:justify-start justify-center">
              <a
                href="#"
                className="text-black dark:text-white dark:hover:text-gray-400 hover:text-gray-500  transition-colors text-lg"
              >
                <FaFacebookF />
              </a>
              <a
