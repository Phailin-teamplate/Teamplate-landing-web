      ...
      <section className="md:pb-20 pb-10 bg-gray-50 dark:bg-blacksection ">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 ">
          <motion.div
            ...
            variants={fadeInUp}
            className="bg-white dark:bg-black dark:border-strokedark border rounded-2xl shadow-xl overflow-hidden"
          >
            <div className="grid grid-cols-1 md:grid-cols-2">
              <div className="p-8 md:p-12 flex flex-col justify-center">
                <h2 className="text-3xl text-center md:text-left font-bold mb-4 font-bold text-primary dark:text-white">
