 ...
 const [imageUrl, setImageUrl] = useState("");
  ...
  return (
    <>
      ...
      <section className="md:pb-20 pb-10 bg-gray-50 dark:bg-blacksection  dark:border-strokedark ">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            variants={fadeInUp}
            className="bg-white dark:bg-black dark:border-strokedark rounded-2xl shadow-xl overflow-hidden"
          >
