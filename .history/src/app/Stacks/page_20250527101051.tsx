    ...
    >
      {tech.imageUrl ? (
        <Image
          ...
          width={50}
          height={50}
          className="mb-2 h-14 w-auto object-contain transition duration-300 dark:invert"
          onError={(e) => {
            // Fallback to default image if load fails
            e.currentTarget.src = "/logos/default.png";
          }}
          unoptimized // Optional: Skip Next.js image optimization if using external images
        />
      ) : (
        <div className="mb-2 h-14 w-14 bg-gray-200 dark:bg-gray-700 rounded-full" />
      )}
