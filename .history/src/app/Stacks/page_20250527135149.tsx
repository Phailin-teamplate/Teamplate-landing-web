...
export default function Stacks() {
    ...
    const load = async () => {
      ...
      const enriched = techCategories.map((category) => ({
        ...
        technologies: category.technologies.map((tech) => {
          ...
          const hasDarkImage = techsWithDarkImages.includes(tech.name);
          ...
          return {
            ...
            darkImageUrl:
              hasDarkImage && logos[darkKey] ? logos[darkKey] : undefined,
            hasDarkFile: hasDarkImage && !!logos[darkKey],
          };
        }),
      }));
  ...
  return (
    <div className="w-full">
        ...
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6 md:px-8">
          <div className="text-center">
            ...
            >
              ...
              <motion.p
                variants={fadeInUp}
                className="mt-2 text-2xl md:text-3xl font-bold text-primary "
              >
                Technology Stack
              </motion.p>
                      ...
                      {tech.hasDarkFile ? (
                        <>
                          ...
                          <Image
                            ...
                            width={50}
                            height={50}
                            className="mb-2 h-14 w-auto object-contain block dark:hidden"
                            onError={(e) =>
                          ...
                          {/* Dark mode image */}
                          <Image
                            src={tech.darkImageUrl || "/logos/default.png"}
                            alt={tech.name}
                            width={50}
                            height={50}
                            className="mb-2 h-14 w-auto object-contain hidden dark:block"
                            onError={(e) =>
                              (e.currentTarget.src = "/logos/default.png")
                            }
                            unoptimized
                        ...
                        <Image
                          ...
                          className={`mb-2 h-14 w-auto object-contain ${
                            ["NextJS", "ExpressJS", "Flask", "Django"].includes(
                              tech.name
                            )
      ...
      <section className="py-20 bg-gray-50 dark:bg-blacksection dark:border-strokedark border-t border-border">
          ...
          >
            {[
              ...
              <motion.div
                ...
                className="bg-white p-8 rounded-xl shadow-lg text-center hover:shadow-xl transition-shadow dark:bg-blacksection dark:border-strokedark border"
              >
