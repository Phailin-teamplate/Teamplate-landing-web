...
export default function Stacks() {
  ...
  technologies: category.technologies.map((tech) => {
    ...
    const darkKey = tech.name === "Kotlin" ? `${key}-dark` : null;
    return {
      ...tech,
      imageUrl: logos[key] || "/logos/default.png",
      darkImageUrl: darkKey ? logos[darkKey] : null,
    };
  }),
}));
  ...
  {tech.name === "Kotlin" && tech.darkImageUrl ? (
    <>
      {/* Light mode image */}
      <Image
        src={tech.imageUrl}
    ...
    <Image
      ...
      className={`mb-2 h-14 w-auto object-contain ${
        ["NextJS", "ExpressJS", "Flask", "Django"].includes(tech.name)
