...
export default function Stacks() {
  ...
  return (
    <div className="w-full">
      ...
      <section className="pb-20 pt-10 bg-gray-50 dark:bg-blacksection dark:border-strokedark border-t border-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-black dark:text-gray-300 ">
          ...
          >
            {[
              ...
              >
                <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-gradient-to-tr from-indigo-100 to-purple-100 mb-6 dark:bg-blacksection dark:border-strokedark border">
                  {item.icon}
                </div>
