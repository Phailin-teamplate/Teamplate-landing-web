...
export default function Login() {
  ...
  <div className="max-w-screen-xl mx-auto px-4 sm:px-6 md:px-8">
    <div className="max-w-md mx-auto bg-white dark:bg-blacksection dark:bg-blacksection  border border-gray-200 dark:border-gray-700 rounded-2xl shadow-xl p-10">
