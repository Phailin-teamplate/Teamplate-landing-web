          ...
          {posts.map((post) => (
            ...
            >
              ...
              <button
                ...
                className="absolute top-3 flex left-3 text-red-500 hover:text-red-700 z-10 bg-white w-8 h-8 items-center justify-center rounded-full"
              ...
              <button
                ...
                className="absolute top-3 right-3 text-blue-600 hover:text-blue-800 z-10 flex bg-white items-center justify-center rounded-full w-8 h-8 hover:bg-gray-100"
