          ...
          {posts.map((post) => (
            ...
            >
              ...
              <button
                ...
                className="absolute top-3 right-3 text-blue-600 hover:text-blue-800 z-10 flex bg-white items-center justify-center rounded-full w-8 h-8 hover:bg-gray-50"
