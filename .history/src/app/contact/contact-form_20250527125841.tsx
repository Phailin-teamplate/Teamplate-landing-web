              ...
              <FormItem>
                ...
                <FormControl>
                  <Input
                    ...
                    {...field}
                    className="dark:bg-blacksection dark:border-strokedark border text-sm rounded-md px-4 py-2 placeholder:text-muted-foreground border border-border focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-shadow"
                  />
                </FormControl>
