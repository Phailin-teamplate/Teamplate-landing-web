    ...
    <div className="w-full">
      ...
      <section className="md:py-20 py-10 bg-gray-50 dark:bg-blacksection overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            {/* Contact Form */}
            <motion.div className="bg-white p-8 md:p-10 rounded-xl shadow-2xl dark:bg-blacksection dark:border-strokedark border">
            ...
            <motion.div className="space-y-8">
              <div className="bg-white p-8 md:p-10 rounded-xl shadow-2xl dark:bg-blacksection dark:border-strokedark border">
                  ...
                  {contactInfo.map((info, index) => (
                    <li key={index} className="flex items-center">
                      ...
                      {info.href ? (
                        <a
                          href={info.href}
                          className="text-lg text-gray-700 dark:text-white dark:hover:text-gray-400 hover:text-blue-600 transition-colors"
                        >
                          {info.text}
                        </a>
                      ) : (
