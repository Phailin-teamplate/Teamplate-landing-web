...
const OurValues: React.FC = () => {
  return (
    <section className="md:pb-0 pt-10 bg-muted/50 dark:bg-background  dark:border-strokedark border-t border-border">
        ...
        >
          {values.map((value, index) => (
            <motion.article
              ...
              className="bg-background rounded-xl p-6 shadow-sm hover:shadow-md transition-all dark:bg-blacksection dark:border-strokedark  border border-border"
            >
