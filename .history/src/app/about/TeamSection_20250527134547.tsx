...
const TeamSection: React.FC = () => {
  return (
    <section className="md:py-20 py-10 bg-muted/50 dark:bg-background dark:border-strokedark border-t border-border">
        ...
        >
          {teamMembers.map((member, index) => (
            <motion.article
              ...
              className="bg-background dark:bg-blacksection dark:border-strokedark  rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-all group border border-border"
            >
